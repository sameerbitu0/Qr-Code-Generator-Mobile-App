...
const Url_Screen = () => {
  ...
  const [colorSetTemporary, setColorSetTemporary] = useState({
    background_color: '#FFFFFF',
    single_color: '#000000',
    gradient_color_1: '#000000',
    gradient_color_2: '#f44336',
  ...
  // Create Qr code validation when input field is null show alert

  function validation() {
    const url = apiVariable.url;
    if (url) {
      generateQRCode();
    } else {
      Alert.alert(
  ...
  const onCloseColorModalWithoutEvent = () => {
    if (showFunctions.single_color === true) {
      showFunctions.single_color = false;
      colorSetTemporary.single_color = apiVariable.single_color;
    } else if (showFunctions.gradient_color_1 === true) {
      showFunctions.gradient_color_1 = false;
      colorSetTemporary.gradient_color_1 = apiVariable.gradient_color_1;
    } else if (showFunctions.gradient_color_2 === true) {
      showFunctions.gradient_color_2 = false;
      colorSetTemporary.gradient_color_2 = apiVariable.gradient_color_2;
    } else if (showFunctions.eye_color_1 === true) {
      showFunctions.eye_color_1 = false;
      colorSetTemporary.eye_color_1 = apiVariable.eye_color_1;
    } else if (showFunctions.eye_color_2 === true) {
      showFunctions.eye_color_2 = false;
      colorSetTemporary.eye_color_2 = apiVariable.eye_color_2;
    } else if (showFunctions.background_color === true) {
      showFunctions.background_color = false;
      colorSetTemporary.background_color = apiVariable.background_color;
    }
    setShowModal(false);
  };
  ...
  const onSelectModalColor = ({hex}) => {
    if (showFunctions.single_color === true) {
      ...
      colorSetTemporary.single_color = hex;
    } else if (showFunctions.gradient_color_1 === true) {
      console.log('Selected gradient_color_1:', hex);
      colorSetTemporary.gradient_color_1 = hex;
    } else if (showFunctions.gradient_color_2 === true) {
      console.log('Selected gradient_color_2:', hex);
      colorSetTemporary.gradient_color_2 = hex;
    } else if (showFunctions.eye_color_1 === true) {
      console.log('Selected eye_color_1:', hex);
      colorSetTemporary.eye_color_1 = hex;
    } else if (showFunctions.eye_color_2 === true) {
      console.log('Selected eye_color_2:', hex);
      colorSetTemporary.eye_color_2 = hex;
    } else if (showFunctions.background_color === true) {
      console.log('Selected background_color:', hex);
      colorSetTemporary.background_color = hex;
    }
  };
  ...
  function updateVariable() {
    apiVariable.single_color = colorSetTemporary.single_color;
    apiVariable.eye_color_1 = colorSetTemporary.eye_color_1;
    apiVariable.eye_color_2 = colorSetTemporary.eye_color_2;
    apiVariable.gradient_color_1 = colorSetTemporary.gradient_color_1;
    apiVariable.gradient_color_2 = colorSetTemporary.gradient_color_2;
    apiVariable.background_color = colorSetTemporary.background_color;
  }
  ...
  // Handle Icon Press set set and upload
      ...
      <KeyboardAvoidingView
        ...
        <ScrollView ref={scrollViewRef}>
          <View style={styles.mainContainer}>
            ...
            <TextInputPaper
              label={STRING_CONSTANTS.url_label}
